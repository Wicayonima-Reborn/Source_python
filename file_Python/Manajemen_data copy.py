    ...
    def tambah_siswa(self):
        ...
        while True:
            try:
                ...
                if usia < 6 or usia > 19:
                    print("🚫 Usia tidak boleh kurang dari 0 Dan Lebih dari 19! Masukkan usia yang valid.")
                else:
                    break
            except ValueError:
                print("🚫 Masukkan usia yang valid (angka).")
        # Validasi nilai
        while True:
            try:
    ...
    def edit_siswa(self):
        ...
        if self.siswa_list:
            try:
                ...
                if 0 <= index < len(self.siswa_list): # memastikan index sama atau lebih dari 0 dan tidak lebih dari self.siswa_list
                    
                    # Fungsi len Adalah menghitung jumlah elemen pada objek
                    ...
                    while True:
                        try:
                            ...
                            if usia < 6 or usia > 19:
                                print("🚫 Usia tidak boleh kurang dari 0 Dan Lenih dari 19! Masukkan usia yang valid.")
                            else:
                                self.siswa_list[index].usia = usia
                                break
                        except ValueError:
                            print("🚫 Masukkan usia yang valid (angka).")
                    ...
                    while True:
                        try:
                            ...
                            if nilai < 0 or nilai > 100:
                                ...
                                self.siswa_list[index].nilai = nilai
                                break
                        except ValueError:
                            print("🚫 Masukkan nilai yang valid (angka).")
